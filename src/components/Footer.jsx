...
import { getSiteData } from "../pages/data";
const Footer = () => {
  ...
  const [sitePrinciples, setSitePrincipleies] = useState();
  ...
  async function getSiteDatas() {
    await getSiteData()
      .then((res) => {
        ...
        setSitePrincipleies(res.siteOurPrinciples);
        setSiteOpeningHours(res.siteOpeningHours);
        console.log(siteSocials);
      })
      .catch((err) => {
