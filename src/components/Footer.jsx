  ...
  return (
    ...
    >
      <div className="row s-footer__content">
        <div className="column xl-3 lg-3 md-12 s-footer__block s-footer__about">
          <h3>Our Principle</h3>
          <p>
            We ensure our vehicles are equipped with first-aid kits. We provide
            a safe, professional service Our vehicles are fully insured.
            Additional seating is provided for family members and or caregivers
            Passionate and respectful drivers. Our vehicles are
            climate-controlled and cleaned daily for our clients's comfort.
          </p>
        </div>
        ...
        <div className="column xl-3 lg-6 md-12 tab-12 s-footer__block s-footer__newsletter">
          <h3>Newsletter</h3>
          <p>
            📬Subscribe to our newsletter for exclusive updates, and exciting
          ...
          <div className="subscribe-form">
            <form id="mc-form" className="mc-form">
              ...
              <input
                ...
                className="btn btn--primary btn--small u-fullwidth"
              />
        ...
        <div className="column xl-3 lg-6 md-12 tab-12 s-footer__block s-footer__newsletter">
          <h3>Opening Hours</h3>
          <p>
          Our normal operating hours are Monday through Friday from 5:am to 5:00pm and Saturday and Sunday 7:am to 3:00pm.
          </p>
        </div>
      </div>
      <div className="row s-footer__bottom">
        <div className="column xl-6 lg-12">
          <ul className="s-footer__social social-list">
            <li>
              <a href="https://web.facebook.com/profile.php?id=61555830655409&_rdc=1&_rdr">
                <svg
            ...
            <li>
              <a href="https://www.instagram.com/nnaydemedcare?igsh=ZGNjOWZkYTE3MQ%3D%3D&utm_source=qr">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width={24}
                  height={24}
        ...
        <div className="column xl-6 lg-12">
          <p className="ss-copyright">
            <span>© Copyright Nnayde {new Date().getFullYear()}</span>
            <span>
              All rights reserved 
            </span>
          </p>
