  ...
  <div className="row s-journal__content width-sixteen-col">
    <div className="column xl-12 grid-block">
      <div className="grid-full section-header text-center">
        ...
        <p>This blog is just the beginning. We want to hear from YOU! Share your own community experiences, ideas, and questions. Let's learn from each other, celebrate 
            our successes, and support each other in building stronger, more vibrant communities.</p>
            <h3>Stay tuned!</h3>
      </div> {/* end section-header */} 
      <div style={{display:'none'}} className="grid-full s-journal__content-main grid-list-items">
        ...
        <div className="grid-list-items__item blog-card">
          <div className="blog-card__header">
            ...
            <h3 className="blog-card__title"><a href="single.html">7 SEO Factors to Consider for Better Website Ranking</a></h3>
          </div>
        ...
        <div className="grid-list-items__item blog-card">
          <div className="blog-card__header">
            ...
            <h3 className="blog-card__title"><a href="single.html">5 Effective Web Design Principles</a></h3>
          </div>
          <div className="blog-card__text">
            <p>
