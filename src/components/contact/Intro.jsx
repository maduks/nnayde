  ...
  return (
    <>
      <div className="column xl-12 lg-12">
        <iframe
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3464.4146158228546!2d-95.62313312367351!3d29.73671153308417!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8640dc419ec78cd1%3A0x90ee23cd416db31c!2s13098%20Westheimer%20Rd%2C%20Houston%2C%20TX%2077077%2C%20USA!5e0!3m2!1sen!2sng!4v1704705702494!5m2!1sen!2sng"
          width="100%"
          height="450"
          style={{ border: 0 }}
          allowfullscreen=""
          ...
          <div className="row">
            <div className="column xl-6 md-12 contact-cta">
              <p>
                ...
                with any queries or concerns. Reach out to us via phone or
                email, and we'll ensure a prompt and helpful response. You can
                also click on the link below to quickly drop a Mail.
              </p>
              <a
                href="mailto:contact@nnayde.com"
            ...
            <div className="column xl-5 md-12 u-flexitem-x-right">
              ...
              <div className="contact-block">
                <h6>Email</h6>
                <a href="mailto:contact@nnayde.com">contact@nnayde.com</a>
              </div>
              <div className="contact-block">
                <h6>Phone</h6>
                <ul className="contact-list">
                  <li>
                    <a href="tel:197-543-2345">+1 832 6714 170</a>
                  </li>
                  <li>
                    <a href="tel:197-123-9876">+1 832 6714 175</a>
                  </li>
                </ul>
              </div>
            </div>
